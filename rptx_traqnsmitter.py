...
class rptx_traqnsmitter(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "This is a demo of how to transmit with rpitx")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("This is a demo of how to transmit with rpitx")
        ...
        self.settings = Qt.QSettings("GNU Radio", "rptx_traqnsmitter")
        ...
        # Blocks
        ##################################################
        self.rpitx_rpitx_source_0 = rpitx.rpitx_source(samp_rate, 144.3e6)
